  ...
  /* ============================ 크로스베일 ============================ */
  {
    ...
    topics: [
      ...
      },
      {
        ...
        text: "남쪽 계곡길을 따라 안쪽으로 파고들면 고블린들이 눌러앉은 요새가 나오네. 미로 같은 동굴 속에 동굴 몬스터와 고블린 무리가 뒤엉켜 있지. 갈림길을 잘 살피게 — 안쪽엔 보물이, 심부엔 로드가 도사리고 있으니.",
      },
      {
        id: "job", label: "전직",
      ...
      {
        id: "lord", label: "고블린 로드",
        text: "그름바크… 요새를 다스리는 고블린 로드일세. 북동쪽 깊은 문 너머 알현실에 도사리고 있네. 놈을 베어야 요새가 마을을 놓아줄 걸세.",
        requires: { quests: ["job_first_promotion"] },
      },
      {
        id: "after", label: "그 후의 요새",
        text: "로드가 쓰러진 뒤, 요새 깊은 물의 방에서 더 오래된 기척이 깨어났다더군. 고대 정령 아스테리온 — 연방보다도 오래된 존재라네. 부디 조심하게.",
        requires: { quests: ["job_final_promotion"] },
      },
    ],
  },
  {
