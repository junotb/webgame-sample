...
export const EVERMORE_FACILITIES: TownFacilityDef[] = [
  { id: "throne", name: "알현실", title: "알현실 — 연방 군주", x: 13, y: 4,
    keeper: { name: "시종장 펠릭", role: "알현 안내관", portrait: 20,
      greetings: [
        "알현! 군주 앞에서는 진실한 말이 화려한 예법보다 중요하지요. 절차는 제가 안내하겠습니다.",
        "예법! 너무 긴장하실 필요는 없습니다. 인사 순서와 서야 할 자리부터 차근차근 알려 드리지요.",
        "진실! 군주께서는 꾸민 말보다 곧은 보고를 귀하게 여기십니다. 전할 말씀을 정리해 보시겠습니까?",
      ] } },
  { id: "temple", name: "대성당", title: "대성당 — 연방 대성소", x: 6, y: 8,
    ...
    keeper: { name: "성직자 리네", role: "대성당 치유사", portrait: 44,
      greetings: [
        "축복! 작은 기도 하나도 먼 길을 버티는 힘이 되지요. 상처와 근심을 잠시 내려놓으세요.",
        "기도! 말로 꺼내기 어려운 걱정도 조용히 맡겨 두세요. 여명의 빛은 모두 듣고 있으니까요.",
        "치유! 몸의 상처와 마음의 피로는 함께 돌봐야 해요. 편히 앉아 어디가 아픈지 알려 주세요.",
      ] } },
  { id: "item", name: "왕도 시장", title: "왕도 시장 — 만물상", x: 21, y: 8,
    keeper: { name: "셀윈", role: "왕도 상인", portrait: 12,
      greetings: [
        "거래! 왕도에서는 없는 물건보다 못 찾는 상인이 더 드물지요. 필요한 걸 말씀만 하세요.",
        "시장! 연방 곳곳의 진귀한 물건이 오늘도 들어왔습니다. 눈길 가는 것부터 천천히 보시지요.",
        "흥정! 좋은 물건에는 합당한 값이 따르는 법이지요. 그래도 단골이 되신다면 이야기는 달라집니다.",
      ] } },
  { id: "inn", name: "여관 '왕관과 방패'", x: 6, y: 14,
    ...
    topics: [
      ...
      greetings: [
        "이야기! 왕도의 밤은 침대보다 소문이 먼저 데워 주지. 방과 식사, 재미난 이야기까지 준비됐어.",
        "환대! 먼 길 온 손님을 세워 두면 왕도 여관 체면이 말이 아니지. 어서 들어와 쉬어.",
        "소문! 사절단부터 모험가까지 한 지붕 아래 모였어. 귀를 열어 두면 재미난 얘기를 건질걸?",
      ] } },
  { id: "stable", name: "마굿간", x: 21, y: 14,
    description: "연방 각지의 문장이 달린 마차들이 가지런히 늘어서 있다.",
    keeper: { name: "가레스", role: "왕도 마차 조합원", portrait: 17,
      greetings: [
        "속도! 왕도의 역마차는 해가 지기 전에 목적지에 닿습니다. 크로스베일행도 곧 출발해요.",
        "역마차! 정해진 시간과 노선을 지키는 것이 조합의 자부심입니다. 목적지를 말씀해 주세요.",
        "출발! 크로스베일로 가실 분은 서둘러 주세요. 짐표를 받으시면 바로 자리를 안내하겠습니다.",
      ] } },
];
